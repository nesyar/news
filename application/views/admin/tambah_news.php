...
<form class="form-horizontal" method="POST" action="<?php echo base_url();?>berita/simpan" onsubmit="return cekform();">

<div class="control-group">
			<label class="control-label">Id News :</label>
			<div class="controls">
...
<div class="control-group">
	...
	<div>
		...
		<a href="<?php echo base_url();?>berita/" class="btn btn-primary btn-small"> Tutup </a>
	</div>
	</p>
</form>